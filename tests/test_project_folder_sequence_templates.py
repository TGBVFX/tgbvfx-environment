...
def get_project_folder_sequence():
...
def test_project_folder_sequence():
    lib.assert_entity(get_project_folder_sequence())


def get_project_folder_sequence_shot():
    return utils.mock_entity(
        ("parent", get_project_folder_sequence()),
        ("project", tpt.get_project()),
        ("name", "sh0010"),
        entity_type="Shot"
    )
...
def test_project_folder_sequence_shot():
    lib.assert_entity(get_project_folder_sequence_shot())


def get_project_folder_sequence_shot_task():
    return utils.mock_entity(
...
def get_project_folder_sequence_shot_task_workfiles():
    entities = []
...
def test_project_folder_sequence_shot_task_workfiles():
    for entity in get_project_folder_sequence_shot_task_workfiles():
        lib.assert_entity(entity)


def get_project_folder_sequence_shot_task_files():
    entities = []
...
def test_project_folder_sequence_shot_task_files():
    for entity in get_project_folder_sequence_shot_task_files():
        lib.assert_entity(entity)


def get_project_folder_sequence_shot_task_imagefiles():
    entities = []
...
def test_project_folder_sequence_shot_task_imagefiles():
    for entity in get_project_folder_sequence_shot_task_imagefiles():
        lib.assert_entity(entity)
...
def get_entities():
    ...
    entities.append(get_project_folder_sequence())
    entities.append(get_project_folder_sequence_shot())
    entities.extend(get_project_folder_sequence_shot_task_files())
    entities.extend(get_project_folder_sequence_shot_task_workfiles())
    entities.extend(get_project_folder_sequence_shot_task_imagefiles())
