...
class TGBMayaRepairScene(pyblish.api.Action):
    ...
    def process(self, context, plugin):
        ...
        expected = TGBMayaValidateScene().get_expected_path(context)
...
class TGBMayaValidateScene(pyblish.api.ContextPlugin):

    order = pyblish.api.ValidatorOrder
    label = "Scene"
    actions = [TGBMayaRepairScene]
    hosts = ["maya"]
